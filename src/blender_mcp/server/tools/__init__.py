...
from ._strict_args import forbid_unknown_tool_arguments
...
# The SDK generates each tool's top-level argument model with pydantic's default `extra="ignore"`,
# so an unknown key would be dropped instead of refused. Harden the tools just registered; see
# `._strict_args` for why the advertised schema already promises otherwise.
